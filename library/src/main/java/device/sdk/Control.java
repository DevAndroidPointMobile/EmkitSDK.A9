...
public class Control {
     ...
     * See {@link Control#setNavigationBarHide(boolean)}
     *
     ...
     * It support only the device what navigation bar exist.
     * See {@link Control#getNavigationBarHide()}
     *
     ...
     * @see  Control#setCustomerMfgData
     */
     ...
     * @see  Control#getCustomerMfgData
     */
     ...
     * @see  Control#setCustomerMfgStringData
     */
     ...
     * @param data customer mfg data to write. (The length of the data should be 64 or less.)
     * @return true if the data write successful, Or false if failure.
     * @see  Control#getCustomerMfgStringData
     */
     ...
     * @see Control#setVibrateIntensity
     */
     ...
     * @see Control#getVibrateIntensity
     */
     ...
     * @see Control#setKeyboardBacklightEnabled
     */
     ...
     * </pre>
     *
     * @see  Control#getKeyboardBacklightEnabled
     */
    ...
    * @see Control#setTouchSensitivityValue
    */
    ...
    * </pre>
    *
    * @see  Control#getTouchSensitivityValue
     */
     ...
     * @see Control#setVibrateOnTouchEnabled
     */
     ...
     * </pre>
     *
     * @see  Control#getVibrateOnTouchEnabled
     */
     ...
     * </pre>
     *
     * @see  Control#setGpsAlwaysOn
     * @see  Control#setGpsAlwaysOff
     */
     ...
     * See {@link Control#getExtensionBrightness()}
     *
    ...
    * @return {@code true} if the operation succeeds, {@code false} otherwise
    */
    public boolean setHotspot(WifiConfiguration config){
        try {
            return DeviceServer.getIDeviceService().setHotspot(config);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
   ...
   * <pre>
    ...
    */
    ...
    /** This API set 5G preference roaming mode.
    * @param enabled {@code boolean} 5G Preference Roaming Mode
    * <pre>
    * "true" : Enable 5G Preference Roaming 
    * "false" : Disable 5G Preference Roaming
    * </pre>
    */
    public void set5GRoamingPreferredMode(boolean enabled){
        try {
            int major = DeviceServer.getIDeviceService().getMajorNumber();
            switch (major) {
                case DevInfoIndex.PM85_MAJOR:
                case DevInfoIndex.PM45_MAJOR:
                    return;
                default : DeviceServer.getIDeviceService().set5GRoamingPreferredMode(enabled);
                    return;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /**
    ** This API get current status of 5G Preference Mode
    * @return {@code true} if the 5G Preference mode is enabled, {@code false} otherwise.
    */
    public boolean get5GRoamingPreferredMode(){        
        try {
            int major = DeviceServer.getIDeviceService().getMajorNumber();
            switch (major) {
                case DevInfoIndex.PM85_MAJOR:
                case DevInfoIndex.PM45_MAJOR:
                    return false;
                default : 
                    return DeviceServer.getIDeviceService().get5GRoamingPreferredMode();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /**
    * * This API set RSSI margin of 5G preference Mode .
    * @param rssi {@code int} RSSI margin of 5G Preference roaming 
    */
    public void set5GRoamingPreferredRSSIMargin(int rssi) {
        try {
            int major = DeviceServer.getIDeviceService().getMajorNumber();
            switch (major) {
                case DevInfoIndex.PM85_MAJOR:
                case DevInfoIndex.PM45_MAJOR:
                    return ;
                default : 
                    DeviceServer.getIDeviceService().set5GRoamingPreferredRSSIMargin(rssi);
                return ;
             }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    * @return RSSI margin.
    */
    public int get5GRoamingPreferredRSSIMargin(){
        try {
            int major = DeviceServer.getIDeviceService().getMajorNumber();
            switch (major) {
                case DevInfoIndex.PM85_MAJOR:
                case DevInfoIndex.PM45_MAJOR:
                    return -1;
                default : 
                    return DeviceServer.getIDeviceService().get5GRoamingPreferredRSSIMargin();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
