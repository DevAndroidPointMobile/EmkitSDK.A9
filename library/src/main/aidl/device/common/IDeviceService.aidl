...
interface IDeviceService {
    ...
    boolean setWifiApEnabled(in WifiConfiguration wifiConfig, boolean enabled);
    ...
    boolean setHotspot(in WifiConfiguration config);
    ...
    void set5GRoamingPreferredMode(boolean enabled);
    boolean get5GRoamingPreferredMode();
    void set5GRoamingPreferredRSSIMargin(int rssi);
    int get5GRoamingPreferredRSSIMargin();
}
